...
public class BurgerKing implements Order {
    ...
    public void placeOrder() {
        for(int i = 1; i <=7; i++) {
            ...
            System.out.println("           Burger King Weekkly Menu");
            System.out.println("1: Whopper Meal");
            System.out.println("2: Original Chicken Sandwich Combo");
            System.out.println("3: Big King Combo");
            System.out.println("=================================================");
            ...
            switch(orderItem) {
                case 1:
                    price = 6.49;
                    System.out.println("\nYour Order:(1) Whopper Meal");
                    System.out.println("\nWhen would you like your order delivered? (MM-dd-yyyy)");
                    dateFormatter();
                    break;
                case 2:
                    price = 6.49;
                    System.out.println("\nYour Order:(2) Original Chicken Sandwich Combo");
                    System.out.println("\nWhen would you like your order delivered? (MM-dd-yyyy)");
                    dateFormatter();
                    break;
                case 3:
                    price = 6.39;
                    System.out.println("\nYour Order:(3) Big King Combo");
                    System.out.println("\nWhen would you like your order delivered? (MM-dd-yyyy)");
                    dateFormatter();
                    break;
                default:
